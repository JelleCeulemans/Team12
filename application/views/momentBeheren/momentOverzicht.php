...
function updateFeestMoment(momentId, startuur, stopuur, dow) {
    ...
    $(document).ready(function() {
        ...
        /**
         * @file momentOverzicht.php
         * fullCalendar is een plugin voor kalender weer te geven
         * @param themeSystem Hiermee kan je verschillende theme's weergeven
         * @param defaultView Hiermee kan je de view veranderen, deze is nu ingesteld met view week
         * @param nowIndicator Hiermee komt er indiciator die de dag van vandaag weergeeft
         * @param minTime Hiermee kan je instellen vanaf welk uur de view begint
         * @param maxTime Hiermee kan je instellen vanaf welk uur de view eindigt
         * @param header Hiermee kan je header maken die boven de kalender verschijnt
         * @param customButtons Hiermee kan je custumbuttons toevoegen, ik heb de button "toevoegen" toegevoegd
         * @param editable Door deze waarde op true te zetten kan je de kalendar bewerken
         * @param resizable Door deze waarde op true te zetten kan je de duur van de event aanpassen
         * @param eventOverlap Door deze waarde op false te zetten kunnen events niet met elkaar overlappen
         * @param eventClick Wanneer je op de event klikt start deze een functie
         * @param eventDrop Wanneer er met event word gesleept zal deze functie gestart worden wanneer het event gedropt word
         * @param eventResize Wanneer de duur van het event word verandert zal deze een functie starten
         * @param eventSources Hiermee kan je de event inladen die vanuit de controller uit de database worden gehaald
         */
        ?>
        $('#Agenda').fullCalendar({
